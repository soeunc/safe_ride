...
public class NcpClientConfig {
    ...
    // geolocation
    @Value("70mgu2av7k")
    private String ncpGeoloClientId;
    @Value("$jw2D5LwBQBwfTF3fNVQxadiaofQWubSsKL7ukuCS")
    private String ncpGeoloClientSecret;
    ...
    public RestClient ncpGeolocationClient() {
        return RestClient
                ...
                .requestInitializer(request -> {
                    ...
                    //2. Acess key
                    requestHeaders.add(X_IAM_ACCESS_KEY, ncpGeoloClientId);
    ...
    // geoloacation
    @Bean
    public GeoLocationInterface geolocationService(){
    ...
    private String makeSignature(HttpMethod method, String url, long timestamp) {
        ...
        String message = new StringBuilder()
                ...
                .append(timestamp)
                .append(newLine)
                .append(ncpGeoloClientId)
                .toString();

        try {
            SecretKeySpec signingKey = new SecretKeySpec(ncpGeoloClientSecret.getBytes(StandardCharsets.UTF_8), "HmacSHA256");
